        ...
        <div className="col-lg-6 align-self-center">
          <div className="about-us-info-wrap">
            <div className="section-title-area ltn__section-title-2--- mb-30 ">
              ...
              <p>We aim at revolutionizing the real estate industry by changing it from an over the counter transaction oriented environment into a dynamic client centric technology platform. </p>
