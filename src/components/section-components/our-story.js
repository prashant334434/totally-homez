			                ...
			                <div className="slide-item-info">
			                  ...
			                  {/*  <h6 className="slide-sub-title white-color--- animated"><span><i className="fas fa-home" /></span> Real Estate Agency</h6>*/}
			                    ...
			                    <div className="slide-brief animated">
			                      <p>A boutique real estate agency and investment advisory company started in 2021, Totally Home LLC is a real estate company based in Dubai, UAE. Our aim is to serve our clients by providing them with the best real estate services they can get. </p>
