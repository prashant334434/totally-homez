        ...
        <div className="col-lg-6 align-self-center ">
          <div className="about-us-info-wrap">
            <div className="section-title-area ltn__section-title-2--- mb-30">
              ...
              <h1 className="section-title"><span>Our Passion </span> </h1>
              <p>Our passion lies in our desire to achieve excellence in what we do by not only giving clients a desirable space to live, but also allowing them to experience the culture and vibrancy of Dubai through its residential properties. </p>
