                                ...
                                apartmentCategoryRentProperties?.map((categoryProperty) => (
									...
									<div key={categoryProperty?.id} className="ltn__product-item ltn__product-item-4 text-center---">
										<div className="product-img go-top">
											<Link to={`/property-details/${categoryProperty?.id}`}><img src={`https://do84cgvgcm805.cloudfront.net/article/719/1200/dbb879e0565240238609342be53a1f24e6340f8771582d24a80d000c10d08438.jpg`} alt="#" /></Link>
